	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="chinhsach.html"><i class="fa fa-newspaper-o"></i> Chính sách</a></li>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/Logo2.png" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">QTH Phone Store</a> - All rights reserved © 2026 - Designed by
            <span style="color: #eee; font-weight: bold">group 10</span></p>
    </div>`);
}
        ...
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0962877252" style="color: #288ad6;">0962877252</a>
                </li>
            </ul>
        </section>
    </div>`);
